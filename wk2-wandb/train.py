...
def run_train(
    ...
    regressor_artifact = wandb.Artifact(
    name='regressor', 
    type='model'
    )    
    ...
    regressor_artifact.add_file(local_path='regressor.pkl', name='rf-regressor')
    run = wandb.init(
        project="mlopszoomcamp", 
        job_type="train"
    )    
    run.log_artifact(regressor_artifact)
